...
$uri = JFactory::getURI();
$uri->getPath() == '/' ? $uri = '/' : $uri = $uri->getPath().'/';
?>

<div <?php if($params->get('form_wrapper_id')) echo $params->get('form_wrapper_id'); ?> class="form-wrapper">
    <div class="form-bg">
        <form class="mail-form form-validate <?php echo $params->get('form_suffix'); ?>" method="post" action="<?php echo $uri; ?>" enctype="multipart/form-data">
            ...
            <div class="controlls">
                <a href="#" class="btn-jsend-submit <?php echo $params->get('btnclass'); ?>" value="Validate"><?php echo $params->get('btntext'); ?></a>
            </div>
